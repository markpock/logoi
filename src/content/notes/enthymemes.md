...
Accordingly, we might understand a valid enthymematic judgment $\Gamma \vdash \phi$ in a context $B$ then as implicitly depending upon the validity of the judgment $B, \Gamma \vdash \phi$. That is, we write (abbreviating enthymematically valid as e-valid) --
$$
\dfrac{
    B, \Gamma \vdash \phi \; \textsf{valid}
}{
    \therefore \Gamma \vdash_B \phi \; \textsf{e-valid}
}
$$
