...
:::callout{tone="violet" sidebar="medium"}
...
-- Georg Wilhelm Friedrich Hegel, The Phenomenology of Spirit ($\S$17).

:::quote-explanation
Example explanation text for testing the reveal behavior. Replace this with your note about what the quote means and why it matters.
:::
::::

::::callout{tone="green" sidebar="medium" reveal}
...
:::quote-explanation
Example explanation text for testing a second reveal card. Replace this with your note about the quote.
:::
::::

:::callout{tone="rose" sidebar="medium"}
...
:::callout{tone="amber" sidebar="medium"}
...
:::callout{tone="teal" sidebar="medium"}
...
:::callout{tone="slate" sidebar="medium"}
...
-- Wilfrid Sellars, Empiricism and the Philosophy of Mind, $\S$63.
:::
...
-- Ludwig Wittgenstein, Philosophical Investigations, $\S$202.
:::

:::callout{tone="green" sidebar="medium"}
...
-- Arthur Schopenhauer, The World as Will and Representation, $\S$19.
:::